...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        books[3] = new Books(4, "978-0-7432-7356-5", "The Da Vinci Code", false, null);
        books[4] = new Books(5, "978-0-525-47563-6", "The Catcher in the Rye", false, null);
        books[5] = new Books(6, "978-1-5011-7184-5", "The Silent Patient", false, null);
        books[6] = new Books(7, "978-1-5387-3630-0", "Becoming", false, null);
        books[7] = new Books(8, "978-0-316-76948-4", "Where the Crawdads Sing", false, null);
        ...
        books[10] = new Books(11, "978-0-553-21311-7", "The Great Gatsby", false, null);
        ...
        books[13] = new Books(14, "978-0-553-21311-9", "The Book Thief", false, null);
        books[14] = new Books(15, "978-0-06-231609-8", "The Road", false, null);
        books[15] = new Books(16, "978-0-316-76948-5", "Atonement", false, null);
        books[16] = new Books(17, "978-1-5387-3630-2", "The Goldfinch", false, null);
        books[17] = new Books(18, "978-0-06-231609-9", "The Kite Runner", false, null);
    ...
    public static void showCheckedOutBooks() {
        for (Books book : books) {
            if (book.isCheckedout()) {
//                System.out.println("Checked out books :" + "\n ID: " + book.getId() + "\n Isbn " + book.getIsbn() + " Title " +
//                        book.getTitle() + "\n Has been checked out by: " + book.getCheckedOutTo());
                System.out.println("Checked out books :" + "\n Has been checked out by: " + book.getCheckedOutTo() +  "\n Title: " +
                        book.getTitle() + "\n ID: " +
                        book.getId() + "\n Isbn " + book.getIsbn() );
            }
